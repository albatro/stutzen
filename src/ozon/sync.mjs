          ...
          for (const item of page) {
            ...
            if (c) {
              upsertOzonCommission({
                ...
                fbo_return_flow_trans_max_amount: c.fbo_return_flow_trans_max_amount ?? null,
                fbo_return_flow_trans_min_amount: c.fbo_return_flow_trans_min_amount ?? null,
                ...
                fbs_return_flow_trans_max_amount: c.fbs_return_flow_trans_max_amount ?? null,
                fbs_return_flow_trans_min_amount: c.fbs_return_flow_trans_min_amount ?? null,
