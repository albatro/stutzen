        ...
        inTx(() => {
          for (const item of items) {
            upsertOzonProduct({
              ...
              name: item.name ?? null,
              category_id: item.description_category_id ?? item.category_id ?? null,
              category_name: item.category_name ?? null,
              image_url: item.primary_image?.[0] ?? item.images?.[0] ?? null,
              barcode: item.barcode ?? null,
              status: item.statuses?.status ?? item.status?.state ?? null,
          ...
          for (const item of page) {
            ...
            if (c) {
              upsertOzonCommission({
                ...
                fbo_direct_flow_trans_max_amount: c.fbo_direct_flow_trans_max_amount ?? null,
                fbo_direct_flow_trans_min_amount: c.fbo_direct_flow_trans_min_amount ?? null,
                fbo_return_flow_amount:           c.fbo_return_flow_amount ?? null,
                fbs_commission_percent:           c.sales_percent_fbs ?? c.sales_percent ?? null,
                fbs_first_mile_amount:            c.fbs_first_mile_min_amount ?? null,
                fbs_first_mile_max_amount:        c.fbs_first_mile_max_amount ?? null,
                fbs_deliv_amount:                 c.fbs_deliv_to_customer_amount ?? null,
                fbs_direct_flow_trans_max_amount: c.fbs_direct_flow_trans_max_amount ?? null,
                fbs_direct_flow_trans_min_amount: c.fbs_direct_flow_trans_min_amount ?? null,
                fbs_return_flow_amount:           c.fbs_return_flow_amount ?? null,
                sales_percent_rfbs:              c.sales_percent_rfbs ?? null,
                sales_percent_fbp:               c.sales_percent_fbp ?? null,
